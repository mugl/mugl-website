<div class="homepage">
	...
	<h1>Reading and Posting To The MUGL Mailing List</h1>
	
	<p class="homepagetext">
		Once you've joined the MUGL Mailing List, all you need
		to do is send an email to
		<a href="mailto:mugl@googlegroups.com">mugl@googlegroups.com</a>
		to post to the list.
	</p>
	<p class="homepagetext">
